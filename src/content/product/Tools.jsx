...
class Tools extends React.Component {
  ...
  async loadData() {
    ...
    const data = await Tools.fetchData(search, showError);
    if (data) {
      this.setState({
...
const ToolsWithToast = withToast(Tools);
ToolsWithToast.fetchData = Tools.fetchData;

export default ToolsWithToast;
